...
gulp.task('copy', function() {
  ...
  // copy php and config files to dist directly
  gulp.src([bases.app + 'php/*.php', bases.app + 'php/.htaccess'])
    .pipe(gulp.dest(bases.dist))
    .pipe(reload({stream:true}));

  // copy docs
  gulp.src(bases.app + 'docs/*.pdf')
    .pipe(gulp.dest(bases.dist + 'docs/'))
    .pipe(reload({stream:true}));
});
...
gulp.task('default', function(done) {
  runSequence('clean:dist', 'browser-sync', 'js-custom', 'js-libs', 'imagemin', 'minify-html', 'styles', 'themes', 'copy', 'fonts', 'watch', done);
});

gulp.task('build', function(done) {
  runSequence('clean:dist', 'js-custom', 'js-libs', 'imagemin', 'minify-html', 'styles', 'fonts', 'copy', done);
});
